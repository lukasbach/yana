...
export const doArraysIntersect = (arr1: any[], arr2: any[]) =>
  arr1.map(item1 => arr2.includes(item1)).reduce((a, b) => a || b, false);
...
export const mergeSearchQueries = (sq1: SearchQuery, sq2: SearchQuery): SearchQuery => ({
  ...
  exactParents:
    (sq1.exactParents || sq2.exactParents) && undup([...(sq1.exactParents || []), ...(sq2.exactParents || [])]),
