  ...
  return (
    ...
    >
      <div className={cx(styles.previewContainer)}>
        <div className={cx(styles.previewTopbarContainer, cxs({ backgroundColor: theme.topBarColor }))}>
          <div className={cx(styles.previewTopbarHighlight, cxs({ backgroundColor: theme.primaryColor }))} />
          <div className={cx(styles.previewTopbarHighlight)} />
          <div className={cx(styles.previewTopbarHighlight)} />
          <div className={cx(styles.previewTopbarHighlight)} />
        </div>
        <div className={cx(styles.previewMainContainer)}>
          <div className={cx(styles.previewSidebarContainer, cxs({ backgroundColor: theme.sidebarColor }))}>
            <div
              className={cx(
                styles.textDummy,
                cxs({
          ...
          <div className={cx(styles.previewPrimaryContentContainer)}>
            <div className={cx(styles.previewColorPaletteContainer)}>
              <div
                className={cxs({
      ...
      {active && (
        <div className={cx(styles.tick, cxs({ color: theme.primaryColor }))}>
